...
import { insertToken, getIndexerState, updateIndexerState } from '../db/index.js';
// Contract addresses
...
const TokenDeployedEvent = parseAbiItem('event TokenDeployed(address indexed token, address indexed nftCollection, bytes32 poolId, address deployer)');
...
async function handleTokenDeployed(log) {
    try {
        ...
        const { token, nftCollection, poolId, deployer } = decoded.args;
